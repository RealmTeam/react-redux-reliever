...
/***/ function(module, exports, __webpack_require__) {
	...
	var _connect2 = __webpack_require__(20);
	...
	var ReduxReliever = function () {
		function ReduxReliever(cls) {
			_classCallCheck(this, ReduxReliever);
		...
		_createClass(ReduxReliever, [{
			key: 'connect',
			value: function connect() {
				var _this = this;

				return (0, _connect3.default)(function (state, dispatch, ownProps) {
					return _extends({}, _this.props(state, ownProps), _this.functions(state, ownProps, dispatch));
				})(this.cls);
			}
		}, {
			key: 'props',
			value: function props(state, ownProps) {
				return ownProps;
			}
		}, {
			key: 'functions',
			value: function functions(state, ownProps, dispatch) {
				return {};
			}
		}, {
			key: 'reducer',
		...
		return ReduxReliever;
	}();

	exports.default = ReduxReliever;
	    ...
	    var Connect = function (_Component) {
	      ...
	      _createClass(Connect, [{
	        ...
	        value: function render() {
	          ...
	          if (withRef) {
	            this.renderedElement = (0, _react.createElement)(WrappedComponent, _extends({}, this.computedProps, {
	              ref: 'wrappedInstance'
	            }));
	          } else {
